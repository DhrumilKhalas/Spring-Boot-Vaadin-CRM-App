...
public class ContactFormTest {
    ...
    public void setupData() {
        ...
        marcUser = new Contact();
        marcUser.setFirstName("Marc");
        marcUser.setLastName("Usher");
        marcUser.setEmail("marc@usher.com");
        marcUser.setStatus(status1);
        marcUser.setCompany(company2);
    }

    @Test
    public void formFieldsPopulated() {
        ContactForm form = new ContactForm(companies, statuses);
        form.setContact(marcUser); 
